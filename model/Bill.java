...
public class Bill {
   ...
   * @param ordDateTime to set date
   */
  public Bill(final int argCustomerId, final int argFoodId, final String argFoodName, final String argWalletName,
      final double argWalletAmount, final int argFoodQty, final double argFoodPrice, final int argOrderId, final String ordDateTime) {
  ...
  public final boolean equals(final Object obj) {
    ...
    if (Objects.equals(customerId, bill.customerId)
        && Objects.equals(foodId, bill.foodId)
        && Objects.equals(foodName, bill.foodName)
        && Objects.equals(walletName, bill.walletName)
        && Objects.equals(walletAmount, bill.walletAmount)
        && Objects.equals(foodQty, bill.foodQty)
        && Objects.equals(foodPrice, bill.foodPrice)
        && Objects.equals(orderId, bill.orderId)
        && Objects.equals(orderDate, bill.orderDate)) {
      return true;
    }
    return false;
  }
  @Override
    ...
    return Objects.hash(customerId, foodId, foodName, walletName, walletAmount, foodQty, foodPrice, orderId, orderDate);
  }
  /**
  ...
  /**
   * @param argOrderDate gets order id.
   */
